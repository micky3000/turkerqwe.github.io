...
$(document).ready(function () {
    function day_message() {
        ...
        var message = hours < 12 ? 'Günaydın' : hours < 18 ? 'İyi Akşamlar' : 'İyi Akşamlar';
        $("#day-message").html(message);
    }
    function cat() { // 0 pazar, 1 pazartesi, 2 salı, 3 çarşamba, 4 perşembe, 5 cuma, 6 cumartesi
        var nndate = new Date(),
        domEnder = function() { var a = nndate; if (/1/.test(parseInt((a + "").charAt(0)))) return "th"; a = parseInt((a + "").charAt(1)); return 1 == a ? "" : 2 == a ? "" : 3 == a ? "" : "" }(),
